    ...
    public partial class SeedingDataforDifficultiesandRegions : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("23c1c360-86b8-4f2a-a469-5a13be7f44fa"), "Medium" },
                    { new Guid("d688bbc9-0d1b-48ab-9cff-cf6a2d2ff54c"), "Hard" },
                    { new Guid("f8af0d20-cee7-4223-926c-ea206e7013cd"), "Easy" }
                });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("23c1c360-86b8-4f2a-a469-5a13be7f44fa"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("d688bbc9-0d1b-48ab-9cff-cf6a2d2ff54c"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("f8af0d20-cee7-4223-926c-ea206e7013cd"));
